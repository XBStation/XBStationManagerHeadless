...
#include "../OpenVPNManger/OpenVPNManager.h"
...
QT_INIT_METAOBJECT const QMetaObject OpenVPNManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_OpenVPNManager.data,
