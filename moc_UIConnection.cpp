...
void UIConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UIConnection::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UIConnection::onClose)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UIConnection::staticMetaObject = {
    { &UIInterface::staticMetaObject, qt_meta_stringdata_UIConnection.data,
      qt_meta_data_UIConnection,  qt_static_metacall, nullptr, nullptr}
};
