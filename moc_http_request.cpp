...
QT_MOC_LITERAL(1, 12, 14), // "signalResponse"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4), // "data"
QT_MOC_LITERAL(4, 33, 10), // "onResponse"
QT_MOC_LITERAL(5, 44, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 59, 5) // "reply"

    },
    "HttpRequest\0signalResponse\0\0data\0"
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalResponse((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (HttpRequest::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpRequest::signalResponse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HttpRequest::signalResponse(QByteArray _t1)
{
