...
QT_MOC_LITERAL(3, 27, 11), // "hostAddress"
QT_MOC_LITERAL(4, 39, 5), // "token"
QT_MOC_LITERAL(5, 45, 11), // "handleStart"
QT_MOC_LITERAL(6, 57, 8), // "username"
QT_MOC_LITERAL(7, 66, 15) // "handleConnected"

    },
    "WebSocketConnection\0start\0\0hostAddress\0"
    "token\0handleStart\0username\0handleConnected"
};
...
void WebSocketConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->start((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->handleStart((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        ...
        {
            using _t = void (WebSocketConnection::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebSocketConnection::start)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WebSocketConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebSocketConnection.data,
      qt_meta_data_WebSocketConnection,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void WebSocketConnection::start(QString _t1, QString _t2)
{
